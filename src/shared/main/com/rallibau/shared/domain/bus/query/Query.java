...
abstract public class Query {
    ...
    public String formatQueueName() {
        return String.format("com.visuallines.%s.%s.%s", contextName(), moduleName(), Utils.toSnake(className()));
    }
    ...
    public Response parseResponse(String message) throws JsonProcessingException {
        return ResponseJsonParser.deserialize(message, Response.class).orElseThrow(()->new QueryHandlerExecutionError());
    }
